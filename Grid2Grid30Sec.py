...
currentPositionXCoord = device.get_current_position('x')
currentPositionX = currentPositionXCoord.astype(int)
device.log(message='Converted to str ' + str(currentPositionX), message_type='success')
